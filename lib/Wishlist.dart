          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                text_custome(text: 'Wishlist', size: 16, fontWeight: FontWeight.w600)
              ],
            ),
                ...
                children: [
                  Flexible(
                    child: SizedBox(
                        height: 550,
                        child: StreamBuilder(
                            stream: FirebaseFirestore.instance.collection("Wishlist").where("User-Email",isEqualTo: userId).snapshots(),
                              ...
                              if (snapshot.hasData) {
                                return cartLength!=0?ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    var wishId = snapshot.data!.docs[index].id;
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  GestureDetector(
                                                    onTap: (){
                                                      FirebaseFirestore.instance.collection("Wishlist").doc(wishId).delete();
                                                    },
                                                    child: Container(
                                                      width: 45,
                                                      height: 45,
